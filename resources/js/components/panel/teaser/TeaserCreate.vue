<template>
    <transition name="route" mode="out-in" appear>
        <section>
            <h3 class="mb-5">ثبت تیزر جدید</h3>

            <div class="row mt-3">
                <div class="col-12 mb-3">
                    <div class="card">
                        <div class="card-body">
                            <form id="editForm" @click="e => enableClick" enctype="multipart/form-data">
                                <div class="row">
    ...
    methods: {
        async createInfo() {
            ...
            if (emptyFieldsCount === 0) {
                await axios.post('/api/panel/teaser', {
                    ...
                    .then((response) => {
                        ...
                        if (response.status === 201 || response.status === 200) {
                            setTimeout(() => {
                                this.$router.push({path: '/panel/teasers'});
                            }, 1000);
